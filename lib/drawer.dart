          ...
          child: new Column(
            children: <Widget>[
              new UserAccountsDrawerHeader(
                accountName: new Text("Subhiksha"),
                accountEmail: new Text("@elishaa"),
                currentAccountPicture: CircleAvatar(
                  radius: 60.0,
                  backgroundColor: const Color(0xFF778899),
                  backgroundImage: NetworkImage("https://www.holex.com/wp-content/uploads/2019/01/Top-14-Valentine-Flowers-2020.jpg"), // for Network image
                ),
